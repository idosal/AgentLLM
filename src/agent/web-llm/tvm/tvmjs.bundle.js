      ...
      commitToWasmMemory(nbytes = this.stackTop) {
        ...
        while (this.addressToSetTargetValue.length != 0) {
          const [targetOffset, valueOffset] =
            this.addressToSetTargetValue.pop();
...
`;
    ...
    class WebGPUContext {
      ...
      drawImageFromBuffer(ptr, height, width) {
        ...
        this.canvasRenderManager.draw(
          this.gpuBufferFromPtr(ptr),
          height,
          width
        );
      }
  ...
  var runtime = createCommonjsModule(function (module, exports) {
    ...
    class RuntimeContext {
      constructor(getGlobalFunc) {
        ...
        this.arrayCacheRemove = getGlobalFunc(
          "vm.builtin.ndarray_cache.remove"
        );
        this.arrayCacheUpdate = getGlobalFunc(
    ...
    class Instance {
      ...
      fetchNDArrayCache(ndarrayCacheUrl, device) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (result === undefined) {
            this.env.logger(
              "Error: Cannot cache " + jsonUrl + ", reloading will be slow"
            );
            try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          for (let i = 0; i < list.length; ++i) {
            ...
            try {
              ...
              if (result == undefined) {
                this.env.logger(
                  "Error: Cannot cache " + dataUrl + ", reloading will be slow"
                );
                result = yield fetch(request);
              }
              ...
              this.env.logger(
                "Error: Cannot fetch " + dataUrl + " err= " + err
              );
              throw err;
            }
